...
python3 src/tools/pwn/pwn_check.py --file ./chall
...
python3 src/tools/pwn/pwn_check.py --file ./chall --host target.com --port 1337
...
python3 src/tools/pwn/pwn_check.py --libc ./libc.so.6
