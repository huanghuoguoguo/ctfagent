...
from src.tools.common.markdown import load_markdown_file
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Query markdown documents")
    parser.add_argument("--root", required=True, help="Root directory to search")
    parser.add_argument("--kind", help="Filter by doc_kind")
    ...
    docs = iter_markdown_documents(args.root)
    filtered = query_documents(
        docs,
        doc_kind=args.kind,
