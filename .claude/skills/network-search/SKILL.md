...
python3 src/tools/common/ddg_search.py "python pickle deserialization RCE"

# Search with result limit
python3 src/tools/common/ddg_search.py "CVE-2024-XXXX nginx" --limit 5

# Save results to file for reference
python3 src/tools/common/ddg_search.py "glibc malloc exploitation" --output research.md
```
...
```bash
python3 src/tools/common/ddg_search.py '"SQL injection" "boolean blind" sqlite'
python3 src/tools/common/ddg_search.py "bash reverse shell one-liner"
```
...
python3 src/tools/common/ddg_search.py "what is <suspicious_header_value> framework"
```

### During Exploitation
```bash
# Look up specific technique
python3 src/tools/common/ddg_search.py "nodejs vm2 sandbox escape 2023"
```

### For Knowledge Capture
```bash
# Document findings
python3 src/tools/common/ddg_search.py "<technique> mitigation strategies" --output notes.md
```
